...
export type WsServerMessage =
  ...
  | { type: 'tool_use_start'; toolName: string; requestId: string; args?: Record<string, unknown> }
  ...
  | { type: 'orchestration_event'; event: 'delegation_started' | 'delegation_completed' | 'fanout_started' | 'fanout_completed' | 'scratchpad_updated' | 'task_created' | 'task_status_changed'; sourceAgentId?: string; targetAgentId?: string; targetAgentIds?: string[]; data?: Record<string, unknown>; timestamp: string };
